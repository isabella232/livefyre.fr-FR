...
| Élément | Clé | Texte par défaut |
|---|---|---|
| Chaînes de menu d’authentification | menuAuthSignInBtn | Se connecter |
...
|  | questionExplanation | Vous pouvez désormais lire et écrire des commentaires directement sur des phrases, des paragraphes, des images et des guillemets.<br><br><span class="&rdquo;lf-highlight-text&rdquo;">Mettez le </span> texte en surbrillance et cliquez sur l’ <span class="&rdquo;fycon-write&rdquo;"></span> icône ou sur l’ <span class="&rdquo;fycon-action-view&rdquo;"></span> icône située à la fin de chaque paragraphe. |
...
| Élément | Clé | Texte par défaut |
|---|---|---|
| Options du menu Répondre | menuRepliesViewTitle | Détails |
...
| Options du menu Indicateur | menuFlagOptionDissame | Désapprouver |
...
| Options de menu etc. | menuEtcOptionApprove | Approuver |
...
| Élément | Clé | Texte par défaut |
|---|---|---|
| Messages de confirmation du menu Plus | notificationApproval | Approuvés |
